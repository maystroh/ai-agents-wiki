...
- [[agent-runtime]] — the runtime's state model (fork/snapshot/durable-per-user) is the substrate that context engineering's stable/volatile prompt placement ultimately persists onto
